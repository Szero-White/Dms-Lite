...
const SERVER_ERROR_KEYS: Record<string, string> = {
  ...
  'Cannot deactivate customer with outstanding debt': 'errors.api.customerOutstandingDebt',
  'Cannot deactivate customer with draft sales orders': 'errors.api.customerDraftOrders',
  ...
  'Inactive customer cannot create or fulfill sales orders': 'errors.api.customerInactive',
  ...
  'Invoice not found': 'errors.api.invoiceNotFound',
  'Sales order not found': 'errors.api.salesOrderNotFound',
  'Invoice requires a completed sales order': 'errors.api.invoiceRequiresCompletedOrder',
  'Cancelled invoice cannot be issued': 'errors.api.cancelledInvoiceIssue',
  'Only draft invoices can be issued': 'errors.api.onlyDraftInvoiceIssue',
  'Cannot cancel an invoice after payment has been recorded': 'errors.api.invoiceCancelAfterPayment',
  'Only active issued invoices can be downloaded': 'errors.api.invoicePdfUnavailable',
  'Failed to generate invoice PDF': 'errors.api.invoicePdfFailed',
  ...
  'Payment not found': 'errors.api.paymentNotFound',
  'Payment requires a completed sales order': 'errors.api.paymentRequiresCompletedOrder',
  'Sales order is already fully paid': 'errors.api.paymentOrderFullyPaid',
  'Payment exceeds sales order remaining debt': 'errors.api.paymentExceedsOrderDebt',
  'Sales order receivable not found': 'errors.api.paymentReceivableNotFound',
  'Sales order has inconsistent receivable records': 'errors.api.paymentReceivableInconsistent',
  'Payment request key was already used for another payment': 'errors.api.paymentRequestKeyUsed',
  'Failed to generate payment receipt PDF': 'errors.api.paymentReceiptPdfFailed',
  'Sales order is required': 'errors.api.salesOrderRequired',
  'Sales order id must be positive': 'errors.api.salesOrderIdPositive',
  'Payment request key is required': 'errors.api.paymentRequestKeyRequired',
