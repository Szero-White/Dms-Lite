...
public class SeedDataRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Role ownerRole = ensureRole(OWNER, permissionMap, PermissionNames.PRODUCT_VIEW,
            ...
            PermissionNames.INVENTORY_MANAGE, PermissionNames.INVOICE_VIEW,
            PermissionNames.INVOICE_CREATE, PermissionNames.INVOICE_ISSUE,
            PermissionNames.INVOICE_CANCEL, PermissionNames.INVOICE_RECORD_PAYMENT,
            PermissionNames.PAYMENT_CREATE, PermissionNames.DEBT_VIEW, PermissionNames.REPORT_VIEW,
            PermissionNames.AUDIT_VIEW, PermissionNames.NOTIFICATION_VIEW,
        ...
        Role salesRole = ensureRole(SALES, permissionMap, PermissionNames.PRODUCT_VIEW,
            ...
            PermissionNames.SALES_ORDER_CANCEL, PermissionNames.INVENTORY_VIEW,
            PermissionNames.INVOICE_VIEW, PermissionNames.INVOICE_CREATE,
            PermissionNames.INVOICE_ISSUE, PermissionNames.INVOICE_CANCEL,
        ...
        Role accountantRole = ensureRole(ACCOUNTANT, permissionMap, PermissionNames.PRODUCT_VIEW,
            ...
            PermissionNames.INVOICE_VIEW, PermissionNames.INVOICE_RECORD_PAYMENT,
    ...
    private Map<String, Permission> ensurePermissions() {
        Set<String> names = Set.of(
            ...
            PermissionNames.INVOICE_RECORD_PAYMENT,
