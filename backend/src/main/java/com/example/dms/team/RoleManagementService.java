...
public class RoleManagementService {
    ...
    private static final Map<String, PermissionMetadata> PERMISSION_METADATA = Map.ofEntries(
        ...
        entry(PermissionNames.INVOICE_VIEW, "View invoices", "Finance", "See invoices and download PDF copies."),
        entry(PermissionNames.INVOICE_CREATE, "Create invoices", "Finance", "Create draft invoices for customers."),
        entry(PermissionNames.INVOICE_ISSUE, "Issue invoices", "Finance", "Issue invoices after review and approval."),
        entry(PermissionNames.INVOICE_CANCEL, "Cancel invoices", "Finance", "Cancel incorrect or invalid invoices."),
        entry(PermissionNames.INVOICE_RECORD_PAYMENT, "Record invoice payments", "Finance", "Record payments against issued invoices."),
