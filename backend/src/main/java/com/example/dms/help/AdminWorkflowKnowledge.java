    ...
    public HelpAnswerResponse teamAccessAnswer(HelpPermissionScope scope, HelpLocale locale) {
        if (locale == HelpLocale.VI) {
            return response(
                ...
                List.of(
                    ...
                    "Gán vai trò đúng với công việc như Nhân viên bán hàng hoặc Kế toán; chỉ tạo vai trò tùy chỉnh khi thật sự cần tách thêm trách nhiệm.",
                    ...
                    "Ba tài khoản demo mặc định được bảo vệ khi chế độ demo đang bật.",
        ...
        return response(
            ...
            List.of(
                ...
                "Assign the role that matches the employee's job, such as Sales or Accountant; create a custom role only when responsibilities need further separation.",
                ...
                "The three default demo accounts stay protected while demo mode is enabled.",
