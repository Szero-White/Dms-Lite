...
> Em không làm web bán hàng CRUD. Em xây dựng một hệ thống DMS mini cho nhà phân phối nhỏ, tập trung vào quản lý đơn hàng, tồn kho và công nợ. Điểm kỹ thuật chính là xử lý transaction khi trừ kho, chống âm kho khi nhiều nhân viên xác nhận đơn đồng thời, thiết kế công nợ dạng ledger, audit log, Redis cache dashboard/permission, RabbitMQ notification nhắc nợ, Flyway migration, Testcontainers integration test và monitoring bằng Prometheus/Grafana.
